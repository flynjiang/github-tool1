...
var require_Mutex = __commonJS({
  "node_modules/@isomorphic-git/lightning-fs/src/Mutex.js"(exports, module) {
    ...
    module.exports = class Mutex {
      ...
      async acquire({ ttl = 5e3, refreshPeriod } = {}) {
        let success;
        let expired;
        let doubleLock;
      ...
      async wait({ interval = 100, limit = 6e3, ttl, refreshPeriod } = {}) {
        while (limit--) {
      ...
      async _keepAlive({ ttl = 5e3, refreshPeriod = 3e3 } = {}) {
...
var require_clock = __commonJS({
  "node_modules/@isomorphic-git/lightning-fs/src/clock.js"(exports, module) {
...
var require_PromisifiedFS = __commonJS({
  "node_modules/@isomorphic-git/lightning-fs/src/PromisifiedFS.js"(exports, module) {
    ...
    var { ENOENT, ENOTEMPTY } = require_errors();
      ...
      _wrap(fn, mutating) {
        ...
        return async (...args) => {
          ...
          try {
            ...
            if (mutating) this.saveSuperblock();
